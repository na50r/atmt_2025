...
#SBATCH --gpus=1
#SBATCH --output=a3_task1_spe.out
...
python translate.py \
    ...
    --src-tokenizer cz-en-a3-task1-base/tokenizers/cz-bpe-8000.model \
    --tgt-tokenizer cz-en-a3-task1-base/tokenizers/en-bpe-8000.model \
    --checkpoint-path cz-en-a3-task1-spe/checkpoints/checkpoint_best.pt \
    --output cz-en-a3-task1-spe/output.txt \
    --max-len 300 \
    --bleu \
